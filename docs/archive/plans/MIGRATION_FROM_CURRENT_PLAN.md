...
> 归档说明：本文件是历史迁移记录，已于 2026-08-09 移至 `docs/archive/plans/`。当前状态见 `../../IMPLEMENTATION_STATUS.md`，长期目标架构见 `../../../MASTER_IMPLEMENTATION_PLAN.md`。
...
| `docs/archive/plans/MASTER_PLAN.md` | 历史基线 | 已归档保留；长期目标由 `../../../MASTER_IMPLEMENTATION_PLAN.md` 描述 |
...
- `docs/archive/plans/MASTER_PLAN.md` 保留为历史设计，不再作为排期真相；
